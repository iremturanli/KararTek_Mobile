...
class KararAramaDeneme extends StatefulWidget {
  const KararAramaDeneme({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _KararAramaDenemeState createState() => _KararAramaDenemeState();
}
...
class _KararAramaDenemeState extends State<KararAramaDeneme> {
