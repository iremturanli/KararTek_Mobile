...
class KararAramaDnmeBottom extends StatefulWidget {
  const KararAramaDnmeBottom({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _KararAramaDnmeBottomState createState() => _KararAramaDnmeBottomState();
}
...
class _KararAramaDnmeBottomState extends State<KararAramaDnmeBottom> {
